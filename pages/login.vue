        ...
        <div class="card border-0">
            <div class="card-header bg-transparent logo" style="border: none">
                <a class="navbar-brand" style="margin-bottom: 20px">
                    <img src="../assets/img/logo-serdadu.png" width="auto" height="40"/>
                </a>
                <div class="text-center text-muted mb-4">
                    <small>Selamat Datang di Aplkasi Sistem Elektronik Pengendalian Terpadu</small>
            ...
            <div class="card-body">
                ...
                <form role="form" @submit.prevent="login()">
                    ...
                    <div class="text-center">
                        ...
                        <router-link to="/admin/beranda">
                        <el-button type="danger" :loading="showLoading" class="my-4" round
                                   native-type="submit">Login
                        </el-button>
                        </router-link>
                        <br>
                        <router-link to="/register">
                        <a href="#">Dafta akun baru</a>
                        </router-link>
                    </div>
                </form>
            </div>
